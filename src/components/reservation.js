	...
	render(){
		return(
			<form onSubmit={this.handleSubmit}>
				...
				<input onChange={this.update} type='number' name='guests' placeholder='Number of People' value={this.state.guests} />
				<input onChange={this.update} type='date' name='date' placeholder='Date' value={this.state.date} />
